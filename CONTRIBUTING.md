...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/vagrant-ansible-citadel
   # Navigate to the newly cloned directory
   cd vagrant-ansible-citadel
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/web-masons/vagrant-ansible-citadel
   ```
